...
export const Index = () => {
  ...
  const titles = [
    ...
    'Swap Rows in Matrix','Finding missing number in an array','Number of set bits in a number', 'Number of zero bits in a number','Sum of primes in an array excluding the largest prime'
  ];
  ...
  const routes = [
    ...
    'swaprowsinmatrix','findingmissingnumberinarray','numberofsetbitsinnumber','numberofzerobitsinnumber','sumofprimesinarrayexcludinglargestprime'
  ];
